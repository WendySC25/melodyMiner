...
// Setters
void Performer::setIdPerformer(int id_performer) { this->id_performer = id_performer;}
void Performer::setIdType(int id_type) { this->id_type = id_type;}
void Performer::setName(const std::string &name) { this->name = name;}
